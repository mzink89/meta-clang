...
PACKAGECONFIG ??= "compiler-rt libcplusplus shared-libs lldb-wchar \
                   ...
                   "
PACKAGECONFIG:class-native = "rtti eh libedit shared-libs"
PACKAGECONFIG:class-nativesdk = "rtti eh libedit shared-libs ${@bb.utils.filter('DISTRO_FEATURES', 'thin-lto lto', d)}"
...
LLVM_PROJECTS:riscv32 ?= "clang;clang-tools-extra;lld"
LLVM_PROJECTS:riscv64 ?= "clang;clang-tools-extra;lld"
